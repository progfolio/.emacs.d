...
#+begin_src emacs-lisp :lexical t
(defvar +theme 'modus-vivendi-tinted "Default theme.")
(require 'cl-lib)
(require 'custom)
...
(with-eval-after-load 'evil
  ...
  (with-eval-after-load 'elpaca-info
    (evil-make-intercept-map elpaca-info-mode-map)
    (add-hook 'elpaca-info-mode-hook (lambda () (visual-line-mode 1) (hl-line-mode 1)))))
...
(use-feature flyspell
  ...
  (+general-global-spelling
    ...
    "w" 'flyspell-word
    "r" 'flyspell-region)
  :hook ((mu4e-compose-mode git-commit-mode) . flyspell-mode))
#+end_src
*** flyspell-correct
#+begin_quote
...
#+begin_src emacs-lisp :lexical t
(use-package org
  :elpaca (org :build (:not elpaca--compile-info elpaca--generate-autoloads-async))
  :defer t
  :general
  ...
  (add-hook 'org-mode-hook (lambda ()
                             (add-hook 'before-save-hook (lambda nil (org-babel-remove-result-one-or-many '(4))) nil t)))
...
(use-package org-better-repeat-mode
  :elpaca (org-better-repeat-mode :host github :repo "progfolio/org-better-repeat-mode" :protocol ssh)
  :after (org)
  :config
...
(use-package skip-buffers
  :elpaca (skip-buffers :host github :repo "progfolio/skip-buffers" :protocol ssh)
  :defer 10
  :config
...
(use-package stardict-utils
  :elpaca (stardict-utils :host github :repo "progfolio/stardict-utils" :protocol ssh)
  :after (general helm)
